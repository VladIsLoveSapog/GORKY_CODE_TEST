...
INTERESTS_QUESTION_MESSAGE = """
    Напишите, что вам интересно — например: история, музеи, библиотеки и т.д.
    """
...
FINAL_MESSAGE = """
    Желаем вам насладиться прогулкой по этому маршруту. Если захотите воспользоваться ботом снова, напишите /reset или используйте кнопку снизу.
    """
